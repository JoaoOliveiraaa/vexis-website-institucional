        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="font-heading text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-balance text-white">
              Transformando Ideias em <span className="text-primary bg-gradient-to-r from-secondary to-secondary/80 bg-clip-text text-transparent">Soluções Digitais</span>
            </h1>
            <p className="text-lg md:text-xl text-muted-foreground text-pretty text-white">
